...
ln6502 -o build/unicone.prg --raw-multiple-memories --list-file build/unicone.lst --verbose --output-format prg --core 45gs02 --target mega65 build/main.o build/setup.o build/dma.o build/irqload.o mega65-plain.scm
