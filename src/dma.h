...
typedef struct _dma_fill_job                  dma_fill_job_t;
...
typedef struct _dma_copy_job_huge_addresses   dma_copy_job_huge_addresses_t;

struct _dma_fill_job {
	char           type;
	char           end_options;
	char           command;
...
struct _dma_copy_job_huge_addresses {
	char           type;
	char           sbank_token;
	char           sbank;
	char           dbank_token;
